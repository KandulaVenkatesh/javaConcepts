...
//class
public class TestCustomerBoolean {

	static  ArrayList<Customer> listCreator(ArrayList<Customer> a,BooleanListGen<Customer> listgen){
		ArrayList<Customer> listbyGeneric=new ArrayList<Customer>();

		for(int i=0;i<a.size();i++){
			if(listgen.compareGenericMethod(a.get(i)) == true){
